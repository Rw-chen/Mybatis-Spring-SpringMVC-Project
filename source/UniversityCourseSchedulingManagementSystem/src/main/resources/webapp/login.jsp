...
<div id="particles-js">
		<div class="login">
			<div class="login-top">
				...
				<form action="<%=request.getContextPath() %>/main/login" method="post" id="form">
				...
				<div class="login-center clearfix">
					<div class="login-center-img"><img src="<%=request.getContextPath() %>/img/password.png"/></div>
					<div class="login-center-input">
						<select name="flag" style="width:200px; background: #13E8E9;">
							<c:forEach items="${list}" var="status">
								<option value="${status.id}">${status.role}</option>
							</c:forEach>
						</select>
						<div class="login-center-input-text">密码</div>
					</div>
